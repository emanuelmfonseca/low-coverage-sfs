...
#SBATCH --job-name=dadi_inference_indiv_gatk_chr20
...
fn='aa_annotated_all_sample_gatk_chr20'
depth_list=['3x',
            '5x',
            '10x',
            '30x'
...
for depth in depth_list:
    # get data dir
    vcf_dir=f'gatk_combined_vcf_{depth}'
    
    # make subsampled data dict from vcf
    dd = dadi.Misc.make_data_dict_vcf(os.path.join(vcf_dir, f'{fn}_only_SNP_filtered.vcf.gz'), 'popfile.txt', subsample=ss)
