...
for inbreed_coef in inbreed_coefs:
    ...
    for replicate in range(replicates):
        ...
        while i < n_snsps:
            silent = subprocess.run(f'slim -d Fis={inbreed_coef} -d ns={ns} -d i={replicate+1} /Users/emanuelmfonseca/projects/LowCoverageGenomes/Scripts/Analyses_scripts/demographic_model_SLiM.slim', stdout=subprocess.PIPE, stderr=subprocess.PIPE, shell=True)
